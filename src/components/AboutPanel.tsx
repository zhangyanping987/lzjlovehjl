    ...
    >
      ...
      >
        <header className="flex shrink-0 items-center justify-between border-b border-white/10 px-5 py-4">
          <h2 className="letter-title text-xl leading-none sm:text-[1.4rem]">
            <span className="bg-gradient-to-r from-teal-100/95 via-white/90 to-cyan-100/95 bg-clip-text text-transparent">
              致「深海」的信
            </span>
            <span className="ml-1.5 inline-block not-italic">💌</span>
          </h2>
          <button
            type="button"
            onClick={onClose}
        ...
        <div className="overflow-y-auto px-5 py-4 text-sm leading-[1.85] text-zinc-300 sm:text-[15px] [&_p]:indent-[2em] [&_p.text-center]:indent-0">
          <p className="mb-3 text-zinc-300">
            <span className="bg-gradient-to-r from-teal-300 via-white to-cyan-200 bg-clip-text text-base font-semibold tracking-wide text-transparent drop-shadow-[0_0_10px_rgba(94,234,212,0.35)] sm:text-lg">
              小歪，生日快乐
            </span>
            {' 🎂 '}
            这是一份独属于你的小礼物，我花心思把关于贺峻霖的许多瞬间收进深海倒映的一片星空 ✨，再捧到你面前。
          </p>
          ...
          <section className="mb-6">
            ...
            <ul className="space-y-3 [&_li]:indent-[2em]">
              <li>
          ...
          <div className="border-t border-white/10 pt-5">
            ...
            <p className="mb-4 text-zinc-400">
              如果这些细节让你在某一刻觉得柔软，那这一页想做的事就完成了。贺峻霖值得被温柔地记住——而你，值得收到这样一份用心准备的礼物。
            </p>
            <p className="text-center text-sm tracking-[0.2em] text-teal-300/75">
              希望你喜欢 🫶
            </p>
          </div>
        </div>
